        ...
        public static List<BlogPost> SeedData()
        {
            return new List<BlogPost>
            {
                ...
                { 
                    ...
                    SummaryImageMarkup = @"<img alt='Fakeator' class='post-avatar pure-img summary-img' src='/assets/logofakeator.png' srcset='/assets/logofakeator-2x.png 2x' />",
                ...
                { 
                    ...
                    SummaryImageMarkup = @"<img alt='Randomer' class='post-avatar pure-img summary-img' src='/assets/logorandomer.png' srcset='/assets/logorandomer-2x.png 2x' />",
                ...
                { 
                    ...
                    SummaryImageMarkup = @"<img alt='DevSummit 2014' class='post-avatar pure-img summary-img' src='/assets/logodevsummit.png' srcset='/assets/logodevsummit-2x.png 2x' />",
                ...
                { 
                    ...
                    SummaryImageMarkup = @"<img alt='TechEd 2013' class='post-avatar pure-img summary-img' src='/assets/logoteched.png' srcset='/assets/logoteched-2x.png 2x' />",
                ...
                new BlogPost
                {
                    ...
                    SummaryImageMarkup = @"<img alt='MapR' class='post-avatar pure-img summary-img' src='/assets/mapr.jpg' srcset='/assets/mapr-2x.png 2x' />",
